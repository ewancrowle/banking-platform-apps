...
import (
	v1c "account-svc/gen/account/v1/accountv1connect"
	"account-svc/internal/rpc"
...
func main() {
	...
	path, handler := v1c.NewAccountServiceHandler(rpc.NewHandler(svc), connect.WithInterceptors(validate.NewInterceptor()))
